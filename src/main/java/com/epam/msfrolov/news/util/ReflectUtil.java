...
import static com.epam.msfrolov.news.util.CommonsUtil.firstUpperCase;
...
//        log.debug("all fields {} - {}", clazz.getSimpleName(), sb.toString());
    ...
    public static List<Object> getClasses() {
        try {
            ...
            for (Iterator iterator = sun.misc.Service.providers(com.epam.msfrolov.news.model.BaseEntity.class);
                 iterator.hasNext(); ) {
